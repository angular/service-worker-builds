...
var SwPush = /** @class */ (function () {
    ...
    SwPush.ngFactoryDef = function SwPush_Factory(t) { return new (t || SwPush)(i0.ɵɵinject(i1.NgswCommChannel)); };
    SwPush.ngInjectableDef = i0.ɵɵdefineInjectable({ token: SwPush, factory: function (t) { return SwPush.ngFactoryDef(t); }, providedIn: null });
    return SwPush;
}());
export { SwPush };
