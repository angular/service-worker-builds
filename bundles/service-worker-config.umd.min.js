 ...
 */
var PARSE_TO_PAIRS=/([0-9]+[^0-9]+)/g,PAIR_SPLIT=/^([0-9]+)([dhmsu]+)$/,WILD_SINGLE="[^\\/]+",WILD_OPEN="(?:.+\\/)?",Endian={Little:0,Big:1};Endian[Endian.Little]="Little",Endian[Endian.Big]="Big";/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
