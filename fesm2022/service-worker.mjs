/**
 * @license Angular v22.1.0-next.6+sha-22aecf5-with-local-changes
 * (c) 2010-2026 Google LLC. https://angular.dev/
 * License: MIT
 */

import * as i0 from '@angular/core';
import { ɵRuntimeError as _RuntimeError, ApplicationRef, Injectable, makeEnvironmentProviders, InjectionToken, provideAppInitializer, inject, Injector, NgZone, ɵformatRuntimeError as _formatRuntimeError, NgModule } from '@angular/core';
...
class SwPush {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    minVersion: "12.0.0",
    version: "22.1.0-next.6+sha-22aecf5-with-local-changes",
    ngImport: i0,
    type: SwPush,
    deps: [{
